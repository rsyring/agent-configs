...
- Lead with the main point, conclusion, or requested action.
...
- Keep paragraphs short and limited to one idea each.
...
- Make email even more scannable than web copy.
- Put the purpose, ask, deadline, or decision needed at the top.
- Keep subject lines and opening sentences specific and informative.
