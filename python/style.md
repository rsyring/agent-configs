...
- When ruff.toml is present, run `ruff format && ruff check --fix --extend-fixable F401 && ruff
  format` after your code edits.
    - a `[ruff]` entry in a pyproject.toml DOES NOT count as a ruff.toml
